...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                ...
                u_action_space = spaces.Box(low=-agent.u_range, high=+agent.u_range, shape=(world.dim_p,)) # shape=(world.dim_p,)
            if agent.movable:
    ...
    def _get_info(self, agent,return_positions=False):
        if self.info_callback is None:
            return {}
        return self.info_callback(agent, self.world, return_positions)
